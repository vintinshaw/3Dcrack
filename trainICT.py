...
def train(args, snapshot_path):
    ...
    # BaseDataSets中包含了所有的图
    # 包括有标签的和无标签的
    # [0:labeled_slice]:有标签数据
    # [labeled_slice:total_slices]:无标签数据
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # 用labeled_bs和batchsize巧妙区分有无标签的数据
            # 但这个既有带标签的，又有无标签的，如何在加载的时候区分？
